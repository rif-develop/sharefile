...
// @updateURL    https://github.com/yujie03/sharefile/raw/master/pcloud/pcloud.user.js
// @downloadURL  https://github.com/yujie03/sharefile/raw/master/pcloud/pcloud.user.js
...
function login(cb) {
	console.log('login');
	console.log('username', pcloud_username);
	var data = {
...
function createFolder(cb) {
	...
	console.log("createFolder name ", today);
	var data = {
		folderid: 0,
		name: today,
		auth: auth
